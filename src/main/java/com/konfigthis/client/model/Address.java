...
public class Address {
  ...
  **/
  ...
  @ApiModelProperty(example = "John Smith / Helcim", required = true, value = "Contact Name or Business Name")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Jump Street 21", required = true, value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "AB", value = "2 letter abbreviation of the province(AB, BC, CA). Required field if country is CAN or USA.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "CAN", value = "3-letter abbreviation of the country(CAN, USA)")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "H0H0H0", required = true, value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "4031231234", value = "10 to 15 digits phone number.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, street1, street2, city, province, country, postalCode, phone, email, additionalProperties);
  }
