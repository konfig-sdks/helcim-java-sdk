...
public class GetInvoices200ResponseInner {
  ...
  public GetInvoices200ResponseInner() {
  }

  public GetInvoices200ResponseInner invoiceId(Double invoiceId) {
  ...
  public GetInvoices200ResponseInner invoiceId(Integer invoiceId) {
  ...
  **/
  ...
  public GetInvoices200ResponseInner invoiceNumber(String invoiceNumber) {
  ...
  **/
  ...
  public GetInvoices200ResponseInner tipAmount(Double tipAmount) {
  ...
  public GetInvoices200ResponseInner tipAmount(Integer tipAmount) {
  ...
  **/
  ...
  public GetInvoices200ResponseInner depositAmount(Double depositAmount) {
  ...
  public GetInvoices200ResponseInner depositAmount(Integer depositAmount) {
  ...
  **/
  ...
  public GetInvoices200ResponseInner notes(String notes) {
  ...
  **/
  ...
  public GetInvoices200ResponseInner dateCreated(String dateCreated) {
  ...
  **/
  ...
  public GetInvoices200ResponseInner dateUpdated(String dateUpdated) {
  ...
  **/
  ...
  public GetInvoices200ResponseInner datePaid(String datePaid) {
  ...
  **/
  ...
  public GetInvoices200ResponseInner dateIssued(String dateIssued) {
  ...
  **/
  ...
  public GetInvoices200ResponseInner status(String status) {
  ...
  **/
  ...
  public GetInvoices200ResponseInner customerId(Integer customerId) {
  ...
  **/
  ...
  public GetInvoices200ResponseInner amount(Double amount) {
  ...
  public GetInvoices200ResponseInner amount(Integer amount) {
  ...
  **/
  ...
  public GetInvoices200ResponseInner convenienceFee(Double convenienceFee) {
  ...
  public GetInvoices200ResponseInner convenienceFee(Integer convenienceFee) {
  ...
  **/
   ...
   * @return the GetInvoices200ResponseInner instance itself
   */
  public GetInvoices200ResponseInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GetInvoices200ResponseInner getInvoices200ResponseInner = (GetInvoices200ResponseInner) o;
    return Objects.equals(this.invoiceId, getInvoices200ResponseInner.invoiceId) &&
        Objects.equals(this.invoiceNumber, getInvoices200ResponseInner.invoiceNumber) &&
        Objects.equals(this.tipAmount, getInvoices200ResponseInner.tipAmount) &&
        Objects.equals(this.depositAmount, getInvoices200ResponseInner.depositAmount) &&
        Objects.equals(this.notes, getInvoices200ResponseInner.notes) &&
        Objects.equals(this.dateCreated, getInvoices200ResponseInner.dateCreated) &&
        Objects.equals(this.dateUpdated, getInvoices200ResponseInner.dateUpdated) &&
        Objects.equals(this.datePaid, getInvoices200ResponseInner.datePaid) &&
        Objects.equals(this.dateIssued, getInvoices200ResponseInner.dateIssued) &&
        Objects.equals(this.status, getInvoices200ResponseInner.status) &&
        Objects.equals(this.customerId, getInvoices200ResponseInner.customerId) &&
        Objects.equals(this.amount, getInvoices200ResponseInner.amount) &&
        Objects.equals(this.convenienceFee, getInvoices200ResponseInner.convenienceFee)&&
        Objects.equals(this.additionalProperties, getInvoices200ResponseInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invoiceId, invoiceNumber, tipAmount, depositAmount, notes, dateCreated, dateUpdated, datePaid, dateIssued, status, customerId, amount, convenienceFee, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetInvoices200ResponseInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetInvoices200ResponseInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetInvoices200ResponseInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetInvoices200ResponseInner is not found in the empty JSON string", GetInvoices200ResponseInner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetInvoices200ResponseInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetInvoices200ResponseInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetInvoices200ResponseInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetInvoices200ResponseInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetInvoices200ResponseInner>() {
           @Override
           public void write(JsonWriter out, GetInvoices200ResponseInner value) throws IOException {
           ...
           @Override
           public GetInvoices200ResponseInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GetInvoices200ResponseInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GetInvoices200ResponseInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetInvoices200ResponseInner
  * @throws IOException if the JSON string is invalid with respect to GetInvoices200ResponseInner
  */
  public static GetInvoices200ResponseInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetInvoices200ResponseInner.class);
  }

 /**
  * Convert an instance of GetInvoices200ResponseInner to an JSON string
  *
  * @return JSON string
  */
