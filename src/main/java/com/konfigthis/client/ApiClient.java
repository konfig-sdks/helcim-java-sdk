...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.helcim.com/v2";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("ApiAccessAuth", new ApiKeyAuth("header", "api-token"));
        ...
        if (configuration != null) {
            if (configuration.apiAccessAuth != null) {
                this.setApiAccessAuth(configuration.apiAccessAuth);
            }
            setVerifyingSsl(configuration.verifyingSsl);
        }
    }

    public String getApiAccessAuth() {
        return ((ApiKeyAuth) this.getAuthentication("ApiAccessAuth")).getApiKey();
    }

    public void setApiAccessAuth(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("ApiAccessAuth")).setApiKey(apiKey);
    }

    public void setApiAccessAuthPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("ApiAccessAuth")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.helcim.com/v2)
